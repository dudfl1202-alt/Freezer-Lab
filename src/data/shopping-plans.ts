...
// ⚠️ 가격 기준: 2026년 1분기 쿠팡 로켓배송/로켓프레시 평균 시세
// 실제 가격은 판매자·시기·할인 여부에 따라 달라질 수 있습니다.
    ...
    portioningGuide: [
      {
        order: 1,
        instruction:
          "냉동 차돌박이 300g을 3등분(약 100g씩) 합니다. 반냉동 상태에서 칼로 잘라야 깔끔합니다.",
        tip: "완전 냉동 상태면 10분 정도 실온에 두고 칼이 들어갈 때 자르세요.",
      },
      {
        order: 2,
        instruction:
          "알배추 1포기를 세로로 반 가른 뒤 한입 크기로 뜯어 3등분합니다.",
      },
      {
        order: 3,
        instruction:
          "버섯은 팽이는 밑동 자르고 새송이는 슬라이스하여 3등분합니다.",
        tip: "버섯은 물에 씻지 말고 키친타월로 닦아야 냉동 시 물이 안 생겨요.",
      },
      {
        order: 4,
        instruction:
          "숙주는 끓는 물에 10초 데친 후 찬물에 헹궈 물기를 짜고 3등분합니다.",
